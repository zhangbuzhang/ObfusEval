...
if __name__ == '__main__':
    ...
    # 从all_dict.xlsx读取数据
    all_dict_df = pd.read_excel(root_path + "all_dict_ga_redis.xlsx",
    ...
    for testModel in testModelList:
        dataFile = root_path + "grammarAsemanticInput_pr4_redis.xlsx"
        resultFile = root_path + testModel + "_result_grammarAsemanticInput_pr4_redis" + round + ".xlsx"
