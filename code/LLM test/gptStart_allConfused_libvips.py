...
if __name__ == '__main__':
    ...
    # 从all_dict.xlsx读取数据
    all_dict_df = pd.read_excel(root_path + "all_dict_se_libvips.xlsx",
    ...
    for testModel in testModelList:
        dataFile = root_path + "complete_symbol_input_libvips.xlsx"
        resultFile = root_path + testModel + "_complete_symbol_input_libvips_" + round + ".xlsx"
