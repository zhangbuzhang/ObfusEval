...
def replace_c_function(file_path, target_function, new_function_code):
    ...
    if function_start is None or function_end is None:
        print(f"在文件 {file_path} 中没有找到函数 {target_function}")
        return 0, covered
...
if __name__ == '__main__':
    numOfInter = 5  
    testModel = "deepseek-coder"  # gpt-3.5-turbo   gpt-4 gpt-4-0125-preview
    ...
    dataFile = root_path + "complete_original_input_libgits.xlsx"
    resultFile = root_path + testModel + "_complete_original_input_libgits.xlsx"
